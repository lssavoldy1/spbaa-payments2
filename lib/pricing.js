// PRICING — the SERVER is the source of truth. Change DUES_CENTS to adjust dues.
...
module.exports = { computeCharge, DUES_CENTS };// PRICING — the SERVER is the source of truth. Change DUES_CENTS to adjust dues.
const DUES_CENTS = 10000;             // $100.00 standard yearly dues
const ASSESSMENT_MIN_CENTS = 100;     // $1.00 floor for a special assessment
const ASSESSMENT_MAX_CENTS = 2000000; // $20,000 sanity cap — adjust to taste
